...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#070F12] text-gray-100 overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-[#003B46]/20 text-[#00A3A9] mb-4 sm:mb-6">
                ...
                <span className="text-xs sm:text-sm">AI-Powered Interview Preparation</span>
              </div>
      ...
      {/* Features Section */}
      <section ref={featuresRef} id="features" className="py-12 sm:py-16 md:py-24 animate-on-scroll relative">
            ...
            <div className="lg:grid lg:grid-cols-3 lg:gap-8">
              {[
                ...
                >
                  ...
                  <p className="mt-2 text-sm sm:text-base text-gray-400 px-2 sm:px-4">{step.description}</p>
      ...
      <section ref={examplesRef} id="examples" className="py-12 sm:py-16 md:py-24 animate-on-scroll relative">
        <div className="absolute inset-0 bg-[url('/placeholder.svg?height=600&width=1200')] bg-cover bg-center opacity-5 mix-blend-overlay"></div>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
          <div
          ...
          <div className="mt-8 sm:mt-12 space-y-6 sm:space-y-8">
            {[
              ...
              >
                <div className="px-4 sm:px-6 py-3 sm:py-4 bg-gradient-to-r from-[#003B46]/30 to-[#006770]/30 border-b border-[#003B46]/20">
                  ...
                  <p className="text-xs sm:text-sm text-gray-400">{example.type}</p>
                </div>
                <div className="px-4 sm:px-6 py-3 sm:py-4">
                  <p className="text-sm sm:text-base text-gray-300">{example.description}</p>
                  ...
                  <div className="mt-3 sm:mt-4 p-3 sm:p-4 bg-[#003B46]/20 rounded-lg border-l-4 border-[#00A3A9]">
                    <p className="text-xs sm:text-sm text-gray-300 italic">"{example.example}"</p>
                  </div>
                </div>
              </div>
            ))}
            ...
            {/* View More Button */}
            <div
              className={`text-center mt-6 sm:mt-8 transition-all duration-700 ${isVisible.examples ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
      ...
      {/* FAQ Section */}
      <section ref={faqRef} className="py-12 sm:py-16 md:py-24 bg-[#003B46]/10 animate-on-scroll relative" id="faq">
        <div className="absolute inset-0 bg-[#070F12] opacity-90"></div>
        <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#00A3A9]/50 to-transparent"></div>
        <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#00A3A9]/50 to-transparent"></div>
      ...
      {/* CTA Section */}
      <section ref={ctaRef} className="py-12 sm:py-16 md:py-24 animate-on-scroll relative" id="cta">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div
            className={`relative rounded-xl sm:rounded-2xl overflow-hidden shadow-xl transition-all duration-1000 ${isVisible.cta ? "opacity-100 translate-y-0" : "opacity-0 translate-y-20"}`}
          >
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="py-8 sm:py-12 md:py-16">
            <div className="grid grid-cols-2 gap-6 sm:gap-8 md:grid-cols-4">
              ...
              <div>
                <h3 className="text-xs sm:text-sm font-semibold text-[#00A3A9] tracking-wider uppercase">Product</h3>
              ...
              <div>
                <h3 className="text-xs sm:text-sm font-semibold text-[#00A3A9] tracking-wider uppercase">Company</h3>
                <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-4">
                  <li>
                    <Link
                      href="./about"
              ...
              <div>
                <h3 className="text-xs sm:text-sm font-semibold text-[#00A3A9] tracking-wider uppercase">Legal</h3>
                <ul className="mt-3 sm:mt-4 space-y-2 sm:space-y-4">
                  <li>
                    <Link
                      href="#"
