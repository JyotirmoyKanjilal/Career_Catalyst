    ...
    onSubmit: (values) => {
      ...
      axios
        ...
        .then((result) => {
          ...
          if (!ISSERVER) {
            // Fix: Use single check for localStorage
            ...
            <form onSubmit={Formik.handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="text-sm">
                  <Link
                    href="#"
                    className="font-medium text-[#00A3A9] hover:text-[#008C8B] transition-colors"
                  >
            ...
            {/* <div className="mt-8">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-[#070F12] text-gray-400">
                    Or continue with
                  </span>
                </div>
              </div>
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center p-12">
            <div className="max-w-md text-center">
              ...
              <p className="text-lg text-white/80 mb-8">
                Get expert answers to your interview questions instantly with
